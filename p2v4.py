...
# 제출 의도
# 예약 기한까지 모아두고,
# 해당 날짜에서 객실 수가 가장 많은 것들부터 잡는다

# 결괏값
# {'accuracy_score': 80.0, 'efficiency_score': 10.0, 'penalty_score': 103.60616782817688, 'score': 486.39383217182314}
...
def solve(problem_num, h, w, day):
    ...
    for cnt in range(1, day + 1):
        ...
        req.sort(key = lambda element: element[1], reverse=True)
